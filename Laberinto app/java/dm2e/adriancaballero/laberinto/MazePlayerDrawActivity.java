...
public class MazePlayerDrawActivity extends /*android.app.Activity*/AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        this.laberintoType = "m1";
        this.nombreJugador = "jugador";
        this.laberintoType = "m5";
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.x_size: { item.setTitle(getString(R.string.x_size, mazeViewer.addCellsX()));return true; }
            case R.id.y_size: { item.setTitle(getString(R.string.y_size, mazeViewer.addCellsY()));return true; }
            case R.id.restart: {
    ...
    private class DpadDrawClick implements View.OnClickListener {
        public void onClick(View v) {
            if (!hasGanado) {
                ...
                switch (v.getId()) {
                    case R.id.up: { hayMovimiento = mazeViewer.up();break; }
                    case R.id.down: { hayMovimiento = mazeViewer.down();break; }
                    case R.id.left: { hayMovimiento = mazeViewer.left();break; }
                    case R.id.right: { hayMovimiento = mazeViewer.right();break; }
...
//            actualizarBD();
        } catch (Exception e) { Log.e(TAG, "(" + id + ")" + e); }
//        actualizarBD();
    }
    ...
    public void onFinish(View v) { onPause();/*setResult(RESULT_OK, new Intent().putExtra("respuesta", String.format(getResources().getString(R.string.ganado), movimientos)));*/finish(); }
    ...
    @Override public void onPause() { if (Musica.getMp() != null && Musica.getMp().isPlaying()) { Musica.onPause();Musica.retirar(); }super.onPause(); }
