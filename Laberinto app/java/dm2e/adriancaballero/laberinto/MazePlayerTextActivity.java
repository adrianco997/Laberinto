...
//        this.laberintoType = "m5";
    ...
    public void play() {
        if (!play(getResourceId(this.laberintoType, "raw"))) {
            onFinish(null);
        }
        this.moves = 0;
...
//                    default: { throw new IllegalStateException("Unexpected value: " + v.getId()); }
                ...
                if (neighbor != null && !neighbor.isErrorChar() && !neighbor.isBarrier()) {
                    /***
                     ...
                     if (!actual.isInput() && !actual.isOutput()) { actual.setSymbol(FileChars.SPACE.c); }
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
                 ...
                 width2  = layout.getMeasuredWidth();
                 height2 = layout.getMeasuredHeight();
}
        });*/
